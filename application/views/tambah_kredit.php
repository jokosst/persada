...
?>
 ...
 <div class="row">
 <div class="col-lg-12">
<h3><i class="fa fa-user fw"></i> TAMBAH KREDIT</h3> 
</div>
</div>
			<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <form action="<?php echo base_url()."welcome/tambah_kredit";?>"method="post"enctype="multipart/form-data">
                                    ...
                                    <input name="kode_nasabah"class="form-control">
										...
										<div class="form-group">
                                            ...
                                            <select name="kota"class="form-control">
                                                <option value="Pontianak">-Pilih-</option>
                                            </select>
                                        </div>										
					   ...
					   <div class="col-lg-6">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Jumlah Angsuran Pokok</label>
